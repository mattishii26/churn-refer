...
const Search = (props) => {
    ...
    const getLinkHandler = async () =>{
        ...
        console.log(creditCardTitle);
        console.log(cardCompanyTitle);
        ...
        if(content != null){
            ...
            >
                <FormControl
                    ...
                    onChange={(ev) => setReferralLink(ev.target.value)}
                />
                <InputGroup.Append>
                    <Button variant="primary" onClick={copyHandler}>Copy Me!</Button>
                </InputGroup.Append>
                </InputGroup>
            );
        }else{
